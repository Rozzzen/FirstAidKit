...
public class Demo {
    public static void main(String[] args) throws FirstAidKitException {
        ...
        FirstAidKit firstAidKit1 = new FirstAidKit(new AdhesivePlaster(10, 50, Material.CLOTH), scalpel, new Notepad(50), pencil, new Garrot(), new ARMask());
        FirstAidKit.Gloves gloves1 = firstAidKit1.new Gloves(Material.RUBBER);

        try {
            gloves1.takeOnGloves();
            ...
            gloves1.takeOffGloves();
        }


        FirstAidKit firstAidKit2 = new FirstAidKit(new GauzeNapkin(5, 10, Material.GAUZE), scalpel, new Notepad(25), redPen, new Garrot(), new ARMask());
        FirstAidKit.Gloves gloves2 = firstAidKit2.new Gloves(Material.LEATHER);
